...
(function(root) {
  var service = {
    xml2jsonArray: xml2jsonArray,
    jsonArray2XmlStr: jsonArray2XmlStr,
    xmlStr2JsonArray: xmlStr2JsonArray,
    jsonArray2Xml: jsonArray2Xml,
  };

  if (typeof define === 'function' && define.amd) {
    define('xml-json-convert', [], service);
  }
  else if (typeof exports === 'object') {
    module.exports = service;
  }
  else {
    root.XmlJsonConvert = service;
  }
